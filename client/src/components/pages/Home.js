    ...
    return (<>
      ...
      <WavyBackground>
        <div ref={this.BeastRowRef} className="beasts-row">
          <BeastCard
            name="Cerberus"
            img="/assets/beasts_white/Cerberus.png"
          ...
          <BeastCard
            name="The Furies"
            img="/assets/beasts_white/Furies.png"
          ...
          <BeastCard
            name="Griffin"
            img="/assets/beasts_white/Griffin.png"
          ...
          <BeastCard
            name="Charybdis"
            img="/assets/beasts_white/Charybdis.png"
        ...
        <div className="beasts-row">
          <BeastCard
            name="Sirens"
            img="/assets/beasts_white/Sirens.png"
            description="Sirens are beautiful and alluring crosses between women and birds. They lure brave adventurers into their clutches with pleasing sight and song. Beware, though -- their enticing visages and enchanting voices have drawn many a sailor to an early, watery grave."
            color={colors.redFavor}
          />
          <BeastCard
            name="Pegasus"
            img="/assets/beasts_white/Pegasus.png"
          ...
          <BeastCard
            name="Sphynx"
            img="/assets/beasts_white/Sphynx.png"
