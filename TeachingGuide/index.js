...
<br /><br />
To that end, we designed STYX by incorporating the elements of its parent game and further emphasizing the focus on the river tiles and their relationship to each other. In order to succeed in STYX, children must manipulate each individual piece and consider how its placement will affect the nature of the field of play as a whole. Experts consider the creation of rudimentary maps and charts to be a fundamental means of heightening a child's spacial reasoning skills -- we consider the core gameplay loop of STYX to focus on this exact pedagogical technique, and highly encourage teachers to engage with their students on the way that the game pieces fit together and interact with each other.
`